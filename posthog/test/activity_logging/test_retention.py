...
class TestActivityLogLookbackWindow(SimpleTestCase):
    @parameterized.expand(
        [
            ...
            ("no limit is unrestricted", {}, None),
            ("explicit unlimited window", {"limit": None, "unit": None}, None),
    ...
    def test_window_for_entitlement(self, _name: str, feature: dict, expected_days: int | None) -> None:
