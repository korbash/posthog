...
# The organization API sends this set to the frontend, so it includes UI-only keys that Python never checks.
UNLIMITED_PRODUCT_FEATURE_KEYS: frozenset[str] = frozenset(feature.value for feature in AvailableFeature) | frozenset(
    {
        "2fa",
        "api_access",
        "apps",
        ...
        "product_analytics_sql_queries",
        "product_analytics_stickiness",
        "release_condition_overrides",
        "replay_automatic_playlists",
        "replay_dom_explorer",
        "replay_feature_flag_based_recording",
        "replay_filter_events",
        "replay_filter_person_properties",
        "replay_mask_sensitive_data",
        "replay_product_analytics_integration",
        "replay_recording_duration_minimum",
        "replay_sharing_embedding",
        "secondary_metrics",
        "session_replay_network_payloads",
        "session_replay_sampling",
        "slack_integration",
        "statistical_analysis",
        "surveys_actions",
        "surveys_all_question_types",
        "surveys_api_mode",
        "surveys_data_retention",
        "surveys_events",
        "surveys_link_question_type",
        "surveys_results_analysis",
        "surveys_slack_notifications",
        "surveys_templates",
        "surveys_unlimited_surveys",
        "surveys_user_sampling",
        "surveys_user_targeting",
        "surveys_wait_periods",
        "targeting_by_group",
        "team_members",
        "tracked_users",
        "user_opt_in",
        "works_with_posthog_js",
    }
)
